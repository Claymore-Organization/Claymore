...
export const TEMP_FORUM_DB: { [key:string]: ForumThread } = {
    'forum1': new ForumThread({title: 'forum1', status: ForumStatus.New, posts: [{authorId: 'user1', datePosted: new Date(), content: 'test content'}]}),
    'forum2': new ForumThread({title: 'forum2', status: ForumStatus.InProgress, posts: [{authorId: 'user2', datePosted: new Date(), content: 'test content'}, {authorId: 'user2', datePosted: new Date(), content: 'test content2'}]}),
}
