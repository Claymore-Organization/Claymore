...
const TEMP_ORDER_DB: { [key:string]: Order } = {
    'order1': new Order({customerId: 'user1', items: [{itemId: 'figure1', quantity: 1}], address: 'Address', status: OrderStatus.New}),
    'order2': new Order({customerId: 'user2', items: [{itemId: 'figure2', quantity: 2}], address: 'Address', status: OrderStatus.InProgress}),
}
